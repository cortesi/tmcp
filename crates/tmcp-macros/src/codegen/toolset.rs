...
use crate::{
    codegen::{
        build_tool_expr, generate_tool_call_arm, group::generate_group_dispatch_chain,
        tool_schema_expr,
    },
    model::ServerInfo,
};
...
pub fn generate_toolset_call_tool(info: &ServerInfo, toolset_field: &syn::Ident) -> TokenStream {
